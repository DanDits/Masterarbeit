...
\usepackage{todonotes} % Hints for TODOs in text (also missing figures,...)
...
\keywords{Kleingordon Gleichung, Zeitintegration, Splitting, Uncertainty quantification} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
Für die Unterstützung bei meiner Masterarbeit und für zahlreiche hilfreiche Ratschläge danke ich insbesondere meinem Betreuer Herr Jahnke. \todo{weitere Korrekturleser o.ö.?}
