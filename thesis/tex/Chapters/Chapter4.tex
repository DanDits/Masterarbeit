...
\caption{Approximation des Erwartungswerts und der Varianz von \nameref{trial:8} mithilfe von Kollokation durch Interpolation und verschiedenen Ansätzen bis zu $P=14$.}
...
\end{figure}
Fügen wir in \nameref{trial:disconttriple} eine weitere Unstetigkeitsstelle für $\alpha$ hinzu und entfernen die Unstetigkeit für $\beta$, so ist in Abbildung \ref{fig:Kollokation_comparison_trialdisconttriple} nur noch mit großer Mühe ein Konvergenzverhalten zu erkennen.
\begin{figure}[!htb]
