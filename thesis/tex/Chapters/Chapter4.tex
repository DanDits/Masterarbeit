...
\begin{figure}[!htb]
\centering
\includegraphics[width=\linewidth]{Figures/collocation_mi_trial4_ft_centralized_p15.png}
\caption{Approximation des Erwartungswerts und der Varianz von \nameref{trial:4} mithilfe von Collocation durch Interpolation und verschiedenen Ansätzen bis zu $P=15$.}
...
\hline
Benötigt keine weiteren Approximationen & Benötigt Quadraturgewichte zu Quadraturpunkten\\
\hline
