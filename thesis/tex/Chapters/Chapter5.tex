...
\end{figure}
\newline
Eine ähnliche Beobachtung machen wir auch für die \nameref{trial:disconttriple} mit 2 Unstetigkeitsstellen in $\alpha$ und stetigem $\beta$ in Abbildung \ref{fig:galerkin_bydegree_trialtriple}. Im Gegensatz zur Collocation die einfache Möglichkeit einen monoton fallenden Fehler zu erhalten ohne große Laufzeitprobleme.
 \begin{figure}[!htb]
\minipage{0.5\textwidth}
