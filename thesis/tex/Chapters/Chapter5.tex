...
\subsection{Einfluss des Polynomgrads $P$}

\subsection{Abschätzung für den Fehler der Fourier-Koeffizienten}
\todo[inline]{Weitere Ergebnisse (über Stoppzeit, pro Knotenpunkt,...)}
...
\todo[inline]{Vergleiche mehrdimensionale, unstetige, nicht diff'bare Beispiele mit Collocation (Problem: Quadratur ist in beiden Fällen schlecht bei unstetigen Funktionen)}