...
\end{figure}
\todo[inline]{Erkläre alternative Generierung, später zeige bessere Konvergenzordnung (empirisch); Problem bei höherer Dimension: Lineare Korrelation, verhalten sich nicht mehr wie Zufallszahlen, dann besser: Sobol Sequenz vgl Quelle: \autocite{halton60}}
...
\todo[inline]{Bilder: Konvergenzordnung von MC anhand von bsp1 und 2; Zeige was R=100000 so bedeutet im Vergleich zu R=317=sqrt(100000); zeige Vorteil von Quasi MC; Erwähne Vorteil dass Konvergenz unabhäng von Dim. von y (zeige entsprechendes BSP)}
